...
public interface AuthService {
     ...
     */
    AuthServiceBO refresh(String refreshToken);
     ...
     */
    AuthUserBO currentUser(AuthPrincipal principal);
     ...
     */
    void changePassword(AuthPrincipal principal, String currentPassword, String newPassword);
}
