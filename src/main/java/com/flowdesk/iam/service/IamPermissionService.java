...
public interface IamPermissionService {
     ...
     */
    PageResult<IamPermissionBO> page(IamPermissionQueryVO query);
     ...
     */
    IamPermissionBO getById(long permissionId);
     ...
     */
    IamPermissionBO create(IamPermissionCreateVO request);
     ...
     * @throws com.flowdesk.common.exception.ApiException 权限不存在时抛出
     */
    IamPermissionBO update(
            long permissionId,
            IamPermissionUpdateVO request
    );
